...
/**
 * Wrapper for {@link VersionParser} to check if the check is happening in
 * developer environment or in a pull request.
 *
...
public final class ModVersionFetcher implements VersionFetcher {
     ...
     *
     * @return {@link DoNotCheckVersion} if in developer environment or pull
     *         request, {@link MissingVersion} in case of a parser exception or else
     *         the parsed {@link Version}.
     */
    @Override
    public Version get() {
