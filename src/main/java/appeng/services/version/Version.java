...
public interface Version {
    ...
    /**
     * A version is never if these criteria are met: if the current revision is
     * higher than the compared revision OR if revision are equal and the current
     * channel is higher than the compared channel (Stable > Beta > Alpha) OR if
