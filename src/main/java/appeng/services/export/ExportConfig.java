...
public interface ExportConfig {
    /**
     * config switch to disable the exporting. if the recipes system is not used
     * there is no reason to export them. Still can be useful for debugging purpose,
    ...
    /**
     * config switch to always refresh the CSV. Might be useful to activate on
     * debugging.
     *
    ...
    /**
     * Will get the cache from last session. Can be used to reduce I/O operations
     * though containing itself calculation.
     *
