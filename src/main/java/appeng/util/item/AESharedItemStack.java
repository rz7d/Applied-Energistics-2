...
final class AESharedItemStack implements Comparable<AESharedItemStack> {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.itemId, this.itemDamage,
    ...
    public static final class Bounds {
        ...
        private AESharedItemStack makeLowerBound(final ItemStack itemStack, final NBTTagCompound tag,
        ...
        private AESharedItemStack makeUpperBound(final ItemStack itemStack, final NBTTagCompound tag,
                final FuzzyMode fuzzy, final boolean ignoreMeta) {
            final ItemStack newDef = itemStack.copy();
            ...
            if (ignoreMeta) {
                ...
                if (newDef.getItem().isDamageable()) {
                    if (fuzzy == FuzzyMode.IGNORE_ALL) {
                        ...
                        final int breakpoint = fuzzy.calculateBreakPoint(itemStack.getMaxDamage());
                        final int damage = itemStack.getItemDamage() < breakpoint ? breakpoint - 1
