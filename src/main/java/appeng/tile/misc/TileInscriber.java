...
public class TileInscriber extends AENetworkPowerTile implements IGridTickable, IUpgradeableHost, IConfigManagerHost {
    ...
    private IInscriberRecipe getTask(final ItemStack input, final ItemStack plateA, final ItemStack plateB) {
        ...
        for (final IInscriberRecipe recipe : AEApi.instance().registries().inscriber().getRecipes()) {
            ...
            final boolean matchA = (plateA.isEmpty() && !recipe.getTopOptional().isPresent()) || (Platform
                    .itemComparisons()
                    .isSameItem(plateA,
            ...
            final boolean matchB = (plateB.isEmpty() && !recipe.getTopOptional().isPresent()) || (Platform
                    .itemComparisons()
                    .isSameItem(plateB,
                            recipe.getTopOptional().orElse(ItemStack.EMPTY)))
                    && // and...
