...
public class BlockQuartzFixture extends AEBaseBlock implements IOrientableBlock, ICustomCollision {
    ...
    /**
     * Sets the "ODD" property of the block state according to the placement of the
     * block.
     */
    @Override
    ...
    public void addCollidingBlockToList(final World w, final BlockPos pos, final AxisAlignedBB bb, final List out,
            final Entity e) {/*
                              ...
                              * xOff + (double) x + 0.15, yOff + (double) y + 0.15, zOff + (double) z +
                              * 0.15,// ahh xOff + (double) x + 0.85, yOff + (double) y + 0.85, zOff +
                              * (double) z + 0.85 ) );
                              */
    }
