...
public class BlockEnergyCellRendering extends BlockRenderingCustomizer {
    ...
    /**
     * Determines which version of the energy cell model should be used depending on
     * the fill factor of the item stack.
     */
    ...
    /**
     * Helper method that returns the energy fill factor (between 0 and 1) of a
     * given item stack. Returns 0 if the item stack has no fill factor.
     */
