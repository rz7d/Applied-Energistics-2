...
/**
 * Utility for managing extended Vertex Formats without having to re-clone
 * existing vertex formats over and over again.
 */
public final class VertexFormats {
    ...
    public static VertexFormat getFormatWithLightMap(VertexFormat format) {
        // Do not use this when Optifine is present or if the vanilla lighting pipeline
        // is used
