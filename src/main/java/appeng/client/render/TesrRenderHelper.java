...
public class TesrRenderHelper {
    ...
    /**
     * Move the current coordinate system to the center of the given block face,
     * assuming that the origin is currently at the center of a block.
     */
    public static void moveToFace(EnumFacing face) {
        GlStateManager.translate(face.getFrontOffsetX() * 0.50, face.getFrontOffsetY() * 0.50,
                face.getFrontOffsetZ() * 0.50);
    }
     ...
     *
     * @param spacing Specifies how far apart the item and the item stack amount are
     *                rendered.
     */
