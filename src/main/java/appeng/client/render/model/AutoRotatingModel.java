...
public class AutoRotatingModel implements IBakedModel {
    ...
    public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
        ...
        // The model has other properties than just forward/up, so it would cause our
        // cache to inadvertendly also cache
        // these
        // additional states, possibly leading to huge isseus if the other extended
        // state properties do not implement
