...
class PlayerMappingsInitializer {
    ...
    /**
     * Creates the initializer for the player mappings. The map will be filled upon
     * construction and will only be filled with valid entries. If an invalid entry
     * is found, an warning is printed, mostly due to migration problems from 1.7.2
     * to 1.7.10 where the UUIDs were introduced.
     *
     * @param playerList the category for the player list, generally extracted using
     *                   the "players" tag
     */
