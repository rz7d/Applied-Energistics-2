...
public final class GrinderRecipeManager implements IGrinderRegistry, IOreListener {
    ...
    public IGrinderRecipe getRecipeForInput(final ItemStack input) {
        ...
        this.log("Recipe for '%1$s' found '%2$s'", input.getUnlocalizedName(),
    ...
    /**
     * Internal {@link IInscriberRecipeBuilder} implementation. Needs to be adapted
     * to represent a correct {@link IInscriberRecipe}
     */
