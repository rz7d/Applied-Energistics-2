...
public final class ApiParts implements IParts {
    ...
    public ApiParts(FeatureFactory registry, PartModels partModels) {
        ...
        // this.lumenCableSmart = Optional.absent(); // has yet to be implemented, no
        // PartType defined for it yet
        // this.lumenCableCovered = Optional.absent(); // has yet to be implemented, no
        // PartType defined for it yet
        // this.lumenCableGlass = Optional.absent(); // has yet to be implemented, no
        // PartType defined for it yet
        // this.lumenCableDense = Optional.absent(); // has yet to be implemented, no
        // PartType defined for it yet
    ...
    /*
     * @Override public IItemDefinition p2PTunnelOpenComputers() { return
