    ...
    public final boolean isPowered() {
        try {
            if (Platform.isServer()) {
                ...
                return ((this.getClientFlags() & AbstractPartReporting.POWERED_FLAG) == AbstractPartReporting.POWERED_FLAG);
            }
        } catch (final GridAccessException e) {
            return false;
        }
    ...
    public final boolean isActive() {
        if (!this.isLightSource()) {
            return ((this.getClientFlags()
                    & (AbstractPartReporting.CHANNEL_FLAG | AbstractPartReporting.POWERED_FLAG)) == (AbstractPartReporting.CHANNEL_FLAG
                            | AbstractPartReporting.POWERED_FLAG));
        } else {
